                        ...
                        <div className="mt-6">
                            ...
                            <form className="flex gap-2" onSubmit={(e) => e.preventDefault()}>
                                <input
                                    ...
                                    className="flex-1 px-3 py-2 rounded-lg text-sm bg-white/10 border border-green-600 text-white placeholder:text-green-400 focus:outline-none focus:border-[#D4A843]"
                                />
                                <button
                                    type="submit"
                                    className="px-3 py-2 bg-[#D4A843] rounded-lg text-sm font-semibold hover:bg-[#b88d2e] transition-colors"
                                >
                                    Go
                                </button>
                            </form>
